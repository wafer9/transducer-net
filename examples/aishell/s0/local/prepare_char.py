...
def lexicon_to_fst_no_sil(
    ...
    # The blank symbol <blank> is defined in local/train_bpe_model.py
...
def generate_tokens(text_file: str) -> Dict[str, int]:
    ...
    tokens_sored = {k: i for i, k in enumerate(sorted(tokens.keys()))}
    tokens_sored["<sos/eos>"] = len(tokens_sored)
    return tokens_sored
